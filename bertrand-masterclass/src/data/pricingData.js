...
export const SERVICES = [
  ...
  {
    id: 'async-review',
    name: 'Video Practice Review',
    subtitle: 'Async Coaching — On Your Schedule',
    description: 'Record your practice, submit it through the app, and receive personalized video feedback from Bertrand within 48 hours. Low pressure, high value.',
    icon: '📹',
    duration: '3-5 min feedback video',
    delivery: 'In-App Submission → Video Response',
    color: '#7b6aaa',
    pricing: [
      { label: 'Single Review', price: 35, unit: 'submission', stripeLink: null },
    ...
    features: [
      'Submit video from your phone anytime',
      'Personalized video feedback within 48 hours',
      'Timestamped notes on your technique',
      'No scheduling needed — practice on your time',
