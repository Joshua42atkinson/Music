...
export const SERVICES = [
  ...
  },
  {
    ...
    description: 'Send Bertrand a question about technique, theory, or practice strategy. Get a thoughtful text reply within 24 hours. The easiest way to get personalized guidance — no video required.',
    icon: '💬',
    ...
    features: [
      ...
      'Bertrand often includes diagrams and references',
    ],
  },
  {
    id: 'mini-critique',
    ...
    description: 'Record a short clip (up to 3 minutes) and Bertrand will send back a focused video with one key thing to work on. Quick, affordable, and encouraging.',
    icon: '🎬',
    ...
    features: [
      ...
      'Bertrand replies with focused feedback (one key improvement)',
  ...
  },
  {
    ...
    description: 'Play for 15 minutes. Bertrand watches the entire session and records himself reacting in real time — giving you a detailed video of his recommendations, corrections, and encouragement. Like having him in the room.',
    icon: '📹',
    ...
    features: [
      ...
      'Bertrand records himself watching and reacting in real time',
  ...
  },
  {
    ...
    description: 'Monthly live group Q&A with Bertrand, priority async review queue, downloadable practice materials, and community access. The textbook is always free — this is for students who want direct access to Bertrand.',
    icon: '⭐',
