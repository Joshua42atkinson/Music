// ═══════════════════════════════════════════════════════════
// BARDIC TITLES — 12 stations of the Troubadour's journey
...
export const BARDIC_TITLES = [
  ...
  },
  {
    ...
    description: 'Eleven semitones — one step from the octave. You are an instrument playing an instrument. The journey and the destination are the same.',
