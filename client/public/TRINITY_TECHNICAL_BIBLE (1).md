...
- PETE avatar visualization and state management
...
- **Avatar System**: Sophisticated PETE avatar with emotional states and visual feedback
...
- `pete_avatar.rs` - PETE avatar visualization and state management
...
├── SME Interview: 64.64GB (PETE + Conductor)
├── Standard Analysis: 72GB (PETE + Conductor)
...
### 1. PETE - Instructional Design Coordinator
...
**Model Foundation**: `MiniMax-M2.5-REAP-50-Q4_K_M` (Shared with PETE, 0GB additional)
...
- **PETE**: 49.2GB (MiniMax-REAP-50) - Coordination
...
- **PETE**: Unloaded during complex reasoning
...
- **Blueprint Reviewer**: Shared with PETE (0GB additional)
- **Total**: 22.8GB + PETE allocation
- **Available**: 73.2GB for system and review tools

**Key Innovation: Model Sharing**
- **MiniMax-REAP-50** shared between PETE and Blueprint Reviewer
...
- PETE is the main guide, not a decorative avatar experiment.
...
7. **[Protocol Agent Memory Specifications](crates/trinity-protocol/AGENT_MEMORY_SPECIFICATIONS.md)**
   - Verified memory assignment tables for each specific agent (PETE, Conductor, Dispatcher, Engineer) including safe rounding margins.
