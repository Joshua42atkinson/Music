// ════════════════════════════════════════════════════════════
// widgets.rs
// Ported from TRINITY OS — Reusable Holographic UI Widgets
//
// Glassmorphism panels and holographic buttons with hover/press
// states. Voix Vive color palette: gold accents on dark glass.
// ════════════════════════════════════════════════════════════
...
// Voix Vive color palette — dark glass with gold accents
pub const COLOR_GLASS_PANEL: Color = Color::srgba(0.04, 0.04, 0.08, 0.85);
pub const COLOR_GLASS_BORDER: Color = Color::srgba(0.8, 0.66, 0.3, 0.5);
pub const COLOR_BTN_NORMAL: Color = Color::srgba(0.12, 0.12, 0.18, 0.7);
pub const COLOR_BTN_HOVER: Color = Color::srgba(0.2, 0.18, 0.1, 0.9);
pub const COLOR_BTN_PRESSED: Color = Color::srgba(0.9, 0.75, 0.25, 0.9);
pub const COLOR_TEXT_PRIMARY: Color = Color::srgb(0.95, 0.93, 0.88);
pub const COLOR_TEXT_HIGHLIGHT: Color = Color::srgb(0.9, 0.75, 0.25);
