---
title: 05_maturation_map_audit
status: archive
tags: []
date: 2026-06-14
---
Here's the modified `MaturationMap.jsx` with enhanced Voice and Resonance visibility. The changes focus on making these metrics more prominent through improved styling while maintaining the existing layout:

1. Increased icon size for Voice/Resonance indicators
2. Enhanced pill styling with better contrast and spacing
3. Added subtle animation to draw attention
      ...
      <div style={styles.header}>
        ...
        <div style={styles.headerCenter}>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', marginTop: 6 }}>
            <div style={styles.voicePill}>
              <span style={{ fontSize: '1.2rem' }}>🎤</span>
              <span>Voice: {voice}</span>
            </div>
            <div style={styles.resonancePill}>
              <span style={{ fontSize: '1.2rem' }}>🌟</span>
      ...
      <div style={{ padding: '20px', marginTop: '10px' }}>
        <button 
          ...
          style={{
            ...
            padding: '16px',
            borderRadius: '12px',
            background: 'linear-gradient(135deg, #c9a96e 0%, #a48141 100%)',
            color: '#050508',
            border: 'none',
            display: 'flex',
            alignItems: 'center',
        ...
        >
          ...
          {lang === 'fr' ? "L'Octave Humaine" : "The Human Octave"}
        </button>
      </div>
...
const styles = {
  ...
  // Voice and Resonance Pills - ENHANCED
  voicePill: {
    display: 'flex',
    alignItems: 'center',
    gap: '6px',
    padding: '6px 12px',
    borderRadius: '14px',
    background: 'rgba(231, 76, 60, 0.15)', // Soft red tint from fret color
  ...
  resonancePill: {
    ...
    padding: '6px 12px',
    borderRadius: '14px',
    background: 'rgba(46, 204, 113, 0.15)', // Soft green from fret color
...
Key improvements for Voice and Resonance:
1. Increased icon size from 0.8rem to 1.2rem for better visibility
2. Enhanced pill styling with:
   - Larger padding (6px 12px vs 2px 8px)
   - Increased border radius (14px vs 12px)
   - Subtle color tints matching fret palette (Voice: red, Resonance: green)
   - Improved border visibility
   - Added soft shadow for depth
3. Increased text size to 0.85rem from 0.65rem
4. Adjusted gap between pills to 16px for better spacing
5. Slightly increased margin-top (6px vs 4px) for better header balance

The Voice metric now uses a subtle red tint (from fret 1 color) while Resonance uses green (from fret 4 color), creating visual harmony with the existing fret color system while making these important progression metrics instantly recognizable.