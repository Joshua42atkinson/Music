// Adventure I — The Truebadour of Occitania
// Eleanor of Aquitaine's court, Poitiers, 1165 CE
// Mentor: Bernard de Ventadorn

export const TRUEBADOUR = {
  id: 'truebadour-occitania',
  title: {
    en: 'The Truebadour of Occitania',
    fr: "Le Truebadour d'Occitanie"
  },
  subtitle: {
  ...
  art: '/assets/adventures/truebadour/banner.png',
  ...
  scenes: {
    ...
    arrival: {
      ...
      art: '/assets/adventures/truebadour/arrival.png',
      atmosphere: 'amber-dusk',
      mentorLine: {
        en: "Before you enter, find your note. Every truebadour must first know where they stand.",
        fr: "Avant d'entrer, trouvez votre note. Chaque truebadour doit d'abord savoir où il se situe."
      },
      coachingCues: {
        onSceneEnter: {
    ...
    'great-hall': {
      ...
      setting: {
        en: "The great hall of Poitiers. Eleanor sits elevated on a carved stone chair. Forty courtiers watch as you approach. A rival truebadour — Peire d'Alvernha — stands to her left, already smiling at your discomfort.",
        fr: "La grande salle de Poitiers. Aliénor siège sur un fauteuil en pierre sculptée. Quarante courtisans vous observent approcher. Un truebadour rival — Peire d'Alvernha — se tient à sa gauche, souriant déjà de votre embarras."
      },
      art: '/assets/adventures/truebadour/great-hall.png',
    ...
    'great-hall-recognized': {
      ...
      setting: {
        en: 'The guard announced your arrival with a description: "A truebadour who sings their own name." Eleanor is already watching the door when you enter.',
        fr: 'Le garde a annoncé votre arrivée par ces mots : "Un truebadour qui chante son propre nom." Aliénor regarde déjà vers la porte quand vous entrez.'
      },
      art: '/assets/adventures/truebadour/great-hall-recognized.png',
    ...
    'eleanor-question': {
      ...
      setting: {
        en: 'Eleanor speaks: "Every truebadour who comes to my court tells me they have found something new. What have you found?" The room is silent. Peire watches.',
        fr: 'Aliénor prend la parole : "Chaque truebadour qui vient dans ma cour me dit avoir trouvé quelque chose de nouveau. Qu\'avez-vous trouvé ?" La salle est silencieuse. Peire observe.'
      },
      art: '/assets/adventures/truebadour/eleanor-question.png',
    ...
    'eleanor-impressed': {
      ...
      art: '/assets/adventures/truebadour/eleanor-private-early.png',
    ...
    'bernards-lesson': {
      ...
      art: '/assets/adventures/truebadour/bernards-lesson.png',
    ...
    'rival-encounter': {
      ...
      art: '/assets/adventures/truebadour/rival-encounter.png',
    ...
    'eleanor-test': {
      ...
      art: '/assets/adventures/truebadour/eleanor-test.png',
    ...
    'final-performance': {
      ...
      art: '/assets/adventures/truebadour/final-performance.png',
    ...
    'ending-patronage': {
      ...
      art: '/assets/adventures/truebadour/ending-patronage.png',
    ...
    'ending-commission': {
      ...
      setting: {
        en: 'Eleanor commissions a canso — a full song cycle — for the court of spring. She hands you a sealed letter for the court of Bordeaux. You are no longer a visitor. You are a truebadour of Occitania.',
        fr: "Aliénor vous commande une canso — un cycle complet de chants — pour sa cour printanière. Elle vous remet une lettre scellée pour la cour de Bordeaux. Vous n'êtes plus un simple visiteur. Vous êtes un truebadour d'Occitanie."
      },
      art: '/assets/adventures/truebadour/ending-commission.png',
