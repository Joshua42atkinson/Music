...
export const HOOK_REGISTRY = {
  useTruebadourAI: {
    file: 'src/hooks/useTruebadourAI.js',
    what: 'Unified AI orchestration: 6-tier LLM cascade + 3-tier TTS + voice input.',
    pedagogy: 'The Truebadour is the AI mentor. Routes to best brain (browser→server→offline).',
    stack: ['Souffle(offline)→Voix(wllama)→Chant(remote vLLM/StepAudio/llama.cpp/LM Studio)'],
    fixAt: 'useTruebadourAI.js → useWllamaTruebadour.js → /models/*.gguf',
  },
  useWllamaTruebadour: {
    file: 'src/hooks/useWllamaTruebadour.js',
    ...
    fixAt: 'useWllamaTruebadour.js → /public/models/ → wllama library',
  },
  useKokoroTTS: {
...
export const COMPONENT_REGISTRY = {
  TruebadourWidget: {
    ...
    pedagogy: 'Truebadour always available. No navigation. Mentor one tap away.',
    pillars: ['class', 'guitar', 'workbook'],
  },
  TruebadourLoom: {
    file: 'src/components/TruebadourLoom.jsx',
...
export const DATA_REGISTRY = {
  truebadourPrompt: {
    file: 'src/data/truebadourPrompt.js',
    what: 'Builds DAG-aware system prompt with somatic polarity, archetypes, protocols.',
    exports: ['buildTruebadourPrompt', 'buildCompressedPrompt', 'buildChatPrompt', 'enforceOver'],
    critical: true,
  },

  playbookData: {
    file: 'src/data/playbookData.js',
    what: 'D&D stats, bard levels, truebadour archetypes, quests, journal prompts.',
    exports: ['BARD_LEVEL_TITLES', 'CORE_STATS', 'TRUEBADOUR_TYPES', 'QUEST_DATA', 'JOURNAL_PROMPTS', 'computeTruebadourProfile'],
    critical: true,
  },
  dagNodes: {
    file: 'src/data/dag/dagNodes.js',
    what: '144-node curriculum DAG (12 frets x 3 pillars x 4 phases). Every node has truebadourPrompt.',
