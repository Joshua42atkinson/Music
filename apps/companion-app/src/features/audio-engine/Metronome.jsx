            ...
            <div 
              ...
              className={`w-4 h-4 rounded-full transition-all duration-75 ${
                currentBeat === i && isPlaying
                  ? i === 0 ? 'bg-cf-gold scale-125 shadow-[0_0_10px_rgba(var(--cf-gold-rgb),0.8)]' : 'bg-cf-sage scale-110 shadow-[0_0_8px_rgba(122,170,136,0.6)]'
                  : 'bg-white/10'
              }`}
            />
          ))}
        ...
        <button 
          ...
          className={`w-full py-4 rounded-xl flex items-center justify-center gap-2 font-bold transition-all ${
            isPlaying 
              ...
              : 'bg-cf-gold text-[#030306] hover:bg-white shadow-[0_0_15px_rgba(var(--cf-gold-rgb),0.2)]'
          }`}
        >
