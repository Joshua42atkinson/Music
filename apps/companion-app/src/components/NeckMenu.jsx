    ...
    <div className="neck-container">
      <style>{`
        ...
        .neck-logo {
          ...
          margin: 0 0 6px;
          line-height: 1.1;
          text-shadow: 0 2px 12px rgba(var(--cf-gold-rgb),0.3);
        }
        .neck-tagline {
        ...
        .neck-content-wrapper {
          ...
          border-left: 1px solid rgba(var(--cf-gold-rgb),0.2);
          border-right: 1px solid rgba(var(--cf-gold-rgb),0.2);
          border-bottom: 1px solid rgba(var(--cf-gold-rgb),0.2);
          margin: 0 16px;
            ...
            <React.Fragment key={item.id}>
              ...
              <div className={`neck-fret ${isOctave ? 'neck-fret-12' : ''}`}>
                ...
                >
                  ...
                  >
                    <span className="drop-shadow-[0_1px_3px_rgba(0,0,0,0.3)]">
                      {item.symbol}
                    </span>
                    <div style={{
                      position: 'absolute',
                  ...
                  <div className="neck-fret-info">
                    <div className="neck-fret-interval" style={{ color: item.color }}>
                      {item.character ? `${item.character} · Chapter ${item.fret}` : `Chapter ${item.fret}`} {item.interval ? `· ${localize(item.interval)}` : ''}
                    </div>
