                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {SIGNATURE_PACKAGES.map(pkg => (
                    <div key={pkg.id} className="bg-[#0f0e0c] border border-cf-gold/20 rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between shadow-2xl">
                      ...
                      <button
                        onClick={() => setActiveTab('screening')}
                        className="w-full py-3 bg-cf-gold text-neutral-900 rounded-xl text-xs font-mono font-bold uppercase tracking-wider flex items-center justify-center gap-1.5 hover:bg-[#ebd4aa] hover:shadow-[0_0_15px_rgba(var(--cf-gold-rgb),0.3)] transition-all"
                      >
                        {t('bookIntakeSession')}
                        <ArrowRight size={14} />
                      </button>
              ...
              >
                ...
                {applicationSubmitted ? (
                  ...
                  <form onSubmit={submitApplication} className="space-y-4">
                    ...
                    <button
                      type="submit"
                      className="w-full py-4 bg-cf-gold text-neutral-900 rounded-xl text-xs font-mono font-bold uppercase tracking-wider hover:bg-[#ebd4aa] hover:shadow-[0_0_20px_rgba(var(--cf-gold-rgb),0.3)] transition-all flex items-center justify-center gap-2"
                    >
                      <Send size={14} />
                      {t('submitProfile')}
                    </button>
