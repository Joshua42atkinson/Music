...
const ONBOARDING_KEY = STORAGE_KEYS.ONBOARDED;
    ...
    <div className="welcome-overlay">
      <style>{`
        ...
        .welcome-icon {
          font-size: 4rem;
          margin-bottom: 24px;
          filter: drop-shadow(0 0 30px rgba(var(--cf-gold-rgb),0.3));
        }
        .welcome-title {
        ...
        .welcome-btn-primary:hover {
          background: rgba(var(--cf-gold-rgb),0.25);
        }
        ...
        .welcome-btn-primary.begin {
          ...
          font-weight: 700;
          border: none;
          box-shadow: 0 0 24px rgba(var(--cf-gold-rgb),0.3);
        }
