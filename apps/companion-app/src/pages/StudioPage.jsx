...
export default function StudioPage() {
  ...
  return (
    <div className="studio-page relative">
      {/* ── NAVIGATION BAR ── */}
      <nav className="flex items-center justify-between pt-4 px-5 max-w-[640px] mx-auto">
        <button
          onClick={() => navigate(-1)}
      ...
      <style>{`
        ...
        .studio-hero::before {
          ...
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse at top, rgba(var(--cf-gold-rgb),0.08) 0%, transparent 70%);
          pointer-events: none;
        }
        .studio-hero-photo {
          width: 120px;
          ...
          border-radius: 50%;
          object-fit: cover;
          border: 3px solid rgba(var(--cf-gold-rgb),0.4);
          margin: 0 auto 20px;
          box-shadow: 0 0 40px rgba(var(--cf-gold-rgb),0.15);
        }
        .studio-hero h1 {
        ...
        .payment-card.primary {
          border-color: rgba(var(--cf-gold-rgb),0.25);
          background: rgba(var(--cf-gold-rgb),0.05);
        }
        .payment-icon {
          font-size: 1.6rem;
        ...
        /* ── CTA Banner ── */
        .cta-banner {
          background: linear-gradient(135deg, rgba(var(--cf-gold-rgb),0.15), rgba(122,170,136,0.1));
        ...
        .cta-button:hover {
          background: #e0d0aa;
          box-shadow: 0 0 30px rgba(var(--cf-gold-rgb),0.3);
        }
        .cta-button:active {
      ...
      <section className="studio-section" id="free-resources">
        ...
        <style>{`
          ...
          .download-item:hover {
            background: rgba(var(--cf-gold-rgb),0.07);
          ...
          .venmo-qr { width: 80px; height: 80px; border-radius: 8px; object-fit: cover; border: 1px solid rgba(var(--cf-gold-rgb),0.2); }
          ...
          <div key={i} className="faq-item">
            ...
            >
              ...
              {expandedFaq === i ? (
                ...
                <ChevronDown size={16} className="text-[#5a6a7a] shrink-0" />
              )}
            </div>
            <AnimatePresence>
              {expandedFaq === i && (
