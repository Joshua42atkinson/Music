...
import { dagNodes, getNodeById, getNodesByFret, getMilestoneForFret, getTotalXp, getFretXp } from '../../data/dag/dagNodes';
...
describe('DAG Node Graph', () => {
  ...
  test('Every node has required fields', () => {
    dagNodes.forEach(node => {
      ...
      expect(node.truebadourPrompt).toBeTruthy();
      expect(node.truebadourPrompt).toMatch(/Over\.?$/); // "Over" or "Over." — Nemotron sometimes omits period
