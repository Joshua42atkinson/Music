...
**Quality Gates & Dueling the Self:**
Instead of leaderboards or rigid system grades, students grade themselves. The **"Duel the Self"** mode allows students to play against their own past recordings, focusing on improving specific metrics they choose (e.g., pacing, breath continuity, or tone) rather than speed.

**Troubadour Notifications & Scheduling:**
To maintain momentum without pressure, the Troubadour AI sends intentional notifications to help students schedule practice. These notifications encourage mental practice (even without the guitar) and deliver async instructor evaluations. Crucially, these notifications are read in Bertrand's high-fidelity cloned voice to maintain somatic safety and connection.
