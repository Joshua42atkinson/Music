> ⚠️ **ARCHITECTURAL STATUS: PHASE D — ASPIRATIONAL**
>
> This Technical Bible describes the **target architecture** for Voix Vive's Desktop-as-a-Server
> (DaaS) paradigm using Tauri + Rust + Axum + SQLite. This architecture is **NOT yet implemented**.
>
> **Current Reality (Phase A-B):** The platform runs as a React SPA deployed on Vercel/Netlify,
> using Supabase for auth/data and Google Drive for file storage. Supabase is actively used
> and has NOT been abandoned.
>
> See `doc 248 - MATURATION MAP SOVEREIGN EDGE.md` for the phased roadmap.
